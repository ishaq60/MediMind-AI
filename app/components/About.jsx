                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-4 text-gray-600 leading-relaxed mb-8">
                            <p>
                                ...
                                incidid unt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
                                exercitation ullamc laboris nisi ut aliquip. Commodo consequat.
                            </p>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor 
                                incidid unt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
                                exercitation ullamc laboris nisi ut aliquip. Commodo consequat. Sed do eiusmod 
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                <h4 className="text-lg font-semibold text-cyan-500">David Ambrose</h4>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white border-2 border-cyan-400 rounded-lg p-6">
                            <h4 className="text-xl font-semibold text-cyan-500 mb-6">Weekly Timetable</h4>
                            
                            <div className="space-y-4">
                                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                                    <span className="text-gray-700">Monday</span>
                                    <span className="text-gray-600">8:00am-7:00pm</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                                ...
                                <div className="flex justify-between items-center py-2">
                                    ...
                                    <span className="text-gray-600">9:00am-3:00pm</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-cyan-500">(+01) - 234 567 890</p>
                                    </div>
                                </div>
                            </div>
                        </div>
