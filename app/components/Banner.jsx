...
const Banner = () => {
    return (
        <div className="relative  mt-4 min-h-[700px] bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-400 overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-1/2 right-1/3 w-16 h-16 bg-cyan-300/20 rounded-full blur-md"></div>
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                <div className="flex flex-col lg:flex-row items-center justify-between h-full min-h-[700px] gap-8">
                    ...
                    {/* Left Content */}
                    <div className="flex-1 text-white z-10 pt-16 lg:pt-0">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                           Diagnostics
                        </h1>
                        
                        <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl leading-relaxed">
                           Get instant symptom analysis, connect with specialists, and receive personalized healthcare recommendations powered by artificial intelligence.
                        </p>
                        
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button className="bg-cyan-400 hover:bg-cyan-300 text-blue-900 font-semibold px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
  Symptom Checker
                            </button>
                            <button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold px-8 py-3 rounded-lg transition-all duration-300">
                                Our service
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 relative lg:flex justify-center lg:justify-end">
                        <div className="relative">
                            ...
                            <div className="w-80 h-96 lg:w-96 lg:h-[480px] relative">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/20 to-white/40 rounded-t-full"></div>
