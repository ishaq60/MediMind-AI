...
• If you have underlying health conditions`,
  ...
  return (
    <div className="lg:h-[900px] md:h-[900px] sm:h-[650px] bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col text-black">
  ...
  <div className="hidden sm:block bg-white shadow-sm border-b border-gray-200 p-4">
    <div className="max-w-4xl mx-auto flex items-center justify-between">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-xl font-bold">MedAssist AI Doctor</h1>
          <p className="text-sm">Get expert medical advice and diagnosis support</p>
        </div>
      </div>
  ...
  <div className="sm:hidden bg-white shadow-sm border-b border-gray-200 p-3">
    <div className="flex items-center space-x-2">
      ...
      <div>
        <h1 className="text-lg font-bold">MedAssist AI</h1>
  ...
  <div className="flex flex-col flex-1 min-h-0">
          ...
          >
            ...
            >
              ...
              {message.type === "bot" ? (
                ...
                <div className="relative px-3 sm:px-4 py-2 rounded-2xl bg-blue-600 text-black rounded-tr-md">
    ...
    <div className="bg-white border-t border-gray-200 p-2 sm:p-4">
      <div className="flex items-end space-x-2 max-w-4xl mx-auto">
        <button className="p-2 hover:text-gray-700 transition-colors hidden sm:block">
    ...
    {/* Footer */}
    <div className="bg-white border-t border-gray-200 p-2 sm:p-3 text-center text-xs max-w-4xl mx-auto w-full">
      <span className="block sm:hidden">
