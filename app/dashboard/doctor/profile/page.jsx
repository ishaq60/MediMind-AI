...
const DoctorDashboardProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    description: "Dr. Sarah Johnson is a renowned cardiologist with over 15 years of experience in diagnosing and treating heart-related conditions. She has performed hundreds of successful cardiac procedures and is known for her patient-centered care.",
    price: "Tk. 1500",
    image: "https://i.ibb.co/jv106syx/defalt2-women.jpg",
    rating: 4.9,
    reviews: 234,
  ...
  // Dashboard stats
  const stats = [
    { icon: Users, label: "Total Patients", value: "1,234", color: "text-blue-600", bg: "bg-blue-50" },
    { icon: Calendar, label: "Appointments Today", value: "12", color: "text-green-600", bg: "bg-green-50" },
    { icon: TrendingUp, label: "This Month", value: "89", color: "text-purple-600", bg: "bg-purple-50" },
    { icon: Star, label: "Average Rating", value: "4.9", color: "text-yellow-600", bg: "bg-yellow-50" }
  ];
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left flex-1">
                ...
                <p className="text-blue-100 text-lg mb-3">{profileData.specialty}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-800">{profileData.price}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 gap-4">
              {profileData.consultationTypes.map((type, index) => (
                <div key={index} className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                  {type === 'In-person' && <User className="w-5 h-5 text-blue-600" />}
                  {type === 'Video Call' && <Video className="w-5 h-5 text-blue-600" />}
                  {type === 'Phone Call' && <Phone className="w-5 h-5 text-blue-600" />}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Patient: John Doe - Today at 3:30 PM</p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-800">New 5-star review received</p>
                <p className="text-sm text-gray-600">Patient: Sarah Wilson left a positive review</p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Consultation fee and availability updated</p>
              </div>
