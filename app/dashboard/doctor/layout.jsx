...
export default function DoctorDashboardLayout({ children }) {
  ...
  const sidebarItemsDoctor = [
    { id: 'overview', label: 'Overview', href: '/dashboard/doctor', icon: Activity },
    { id: 'diagnosis', label: 'AI Diagnosis', href: '/dashboard/doctor/disease-detector', icon: Brain },
    { id: 'patients', label: 'Patients', href: '/dashboard/doctor/patients', icon: Users },
    { id: 'reports', label: 'Reports', href: '/dashboard/doctor/reports', icon: FileText },
    { id: 'profile', label: 'Profile', href: '/dashboard/doctor/profile', icon: Settings },
  ];
